...
- Planning the Application UI Structure
- Breaking UI into Reusable Components
- Application Layout (Header, Body, Footer)
- Writing CSS in JSX (Inline Styling)
- Passing Props to Components
- Config Driven UI
- Creating Reusable Components
- Object Destructuring (Industry Practice)
- JavaScript Array Methods for UI Rendering
  - map()
  - filter()
  - reduce()
...
- Best Practice: Using Unique Keys
