...
- Bundlers and Their Purpose
- Popular Bundlers (Parcel, Vite, Webpack)
- Version Symbols in `package.json`
  - Caret (`^`)
  - Tilde (`~`)
  - Fixed Version
- `package-lock.json` and Version Locking
- `node_modules` Folder
- Transitive Dependencies
- `.gitignore` and Ignored Files
- Running a Project with Parcel
- Using `npx` to Execute Packages
- ES Modules in the Browser (`type="module"`)
- Parcel Features
  - Development Features
  - Optimization Features
  - Compatibility Features
- Parcel Cache (`.parcel-cache`)
- Creating Production Builds with Parcel
- `dist` Folder (Production Output)
- Browser Compatibility with `browserslist`
