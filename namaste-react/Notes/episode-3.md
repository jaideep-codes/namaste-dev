...
- NPM Scripts for Running and Building the Project
- DOM Elements vs React Elements
- JSX (JavaScript XML)
- JSX vs `React.createElement()`
- JSX Compilation Process (Babel Transpilation)
- Multi-line JSX Rules
- Differences Between HTML and JSX
- React Components Overview
  - Class Components
  - Functional Components
- Functional Component Syntax (Arrow Functions)
- Component Naming Convention (Capitalization)
- Rendering Components with `root.render()`
- Component Composition
- Writing JavaScript Inside JSX (`{}`)
- Rendering React Elements Inside Components
- JSX Composition Flexibility
- JSX Security and XSS Protection
