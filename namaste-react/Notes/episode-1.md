# 🚀 React Episode 1 — Introduction to React & Basic Setup

---

# 📚 Concepts Covered

- Basic HTML Boilerplate (`html:5` in VS Code)
- Root Element in React (`<div id="root">`)
- React vs ReactDOM
- Rendering React into the Browser DOM
- Basic Hello World in React
- Using React and ReactDOM via CDN
- CDN (Content Delivery Network)
- `crossorigin` Attribute in Script Tags
- CORS (Cross-Origin Resource Sharing)
- `React.createElement()` Syntax
- React Elements (JavaScript Object Representation)
- Creating Nested Elements with `React.createElement()`
- Creating Sibling Elements using Arrays
- Introduction to npm (Node Package Manager)
- Using `npm install`
- Introduction to `npx`
- Running Packages using `npx`
- React as a JavaScript Library
- Difference Between React and Frameworks
